...
| 🏙️ **Six Cities** | Приложение по аренде жилья в 6 городах Европы: авторизация, избранное, фильтрация, сортировка, интерактивные карты, рейтинги, отзывы. Полностью на TypeScript | React, Redux Toolkit, TypeScript, Axios, Vite, Leaflet, React Router | [GitHub](https://github.com/Mirror45/six-cities) |
